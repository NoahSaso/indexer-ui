...
>({
  ...
  return (
    ...
    >
      ...
      <input
        className={clsx(
          'ring-none secondary-text w-full grow appearance-none border-none bg-transparent text-right font-mono text-text-body outline-none',
          className,
          textClassName
        )}
        disabled={disabled}
