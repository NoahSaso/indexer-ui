...
import { accountToken, loggingInAtom } from '@/state'
...
export const useLogin = () => {
  ...
  const [token, setToken] = useRecoilState(accountToken(publicKey?.hex ?? ''))
  const [loggingIn, setLoggingIn] = useRecoilState(loggingInAtom)
